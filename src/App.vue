<template>
  ...
  <!-- Technically, you can use camelCase when passing props to a child component. However, the convention is using kebab-case to align with HTML attributes. -->
  <BlogPost
    id="1"
...
//copy and fast. an array of blog posts
let posts = ref([
  {
    id: 1,
